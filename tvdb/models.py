...
class Season(models.Model):
	...
	def _get_url_string(self):
		"URL Encode of season number"
		return "s" + str(self.season_number)

	url_string = property(_get_url_string)

	def _get_average_episode_rating(self):
		"Average of episode ratings"
		return Season.objects.aggregate(avg_episode_rating=models.Avg('episode__rating'))
